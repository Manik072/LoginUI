  ...
  <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div className="w-full bg-white rounded-xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <h3 className="text-sm leading-tight tracking-tight text-gray-600  dark:text-white text-left">Enter your email & password to login</h3>
                  ...
                  <div className="flex items-center justify-between">
                      <div className="flex items-start">
                          ...
                          <div className="ml-3 text-sm">
                            <label for="remember" className="text-gray-500 dark:text-gray-300">Keep me signed in</label>
                          </div>
                      </div>
                      <a href="#" className="text-sm font-medium text-blue-700">Forgot password?</a>
                  </div>
                  <button type="submit" className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-700">Sign in</button>
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                    You don't have an account yet? <a href='' className="font-medium text-blue-700 hover:underline dark:text-primary-500">Register now</a>
                  </p>
              </form>
          </div>
      </div>
